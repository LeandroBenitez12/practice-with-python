...
entrenamientoEigenFaceRecognizer.read(
    'C:/Users/juana/Dropbox/GIT/Train-RecFacial/test_one/EntrenamientoEigenFaceRecognizer.xml')
...
while True:
    ...
    for x, y, b, h in caras:
        ...
        rostro_capture = cv.resize(
            rostro_capture, [600, 600], interpolation=cv.INTER_CUBIC)
        ...
        if resultado[1] < max_Result:
            ...
            cv.putText(enVivo, f'The person is not found...',
                       (x, y-40), 2, 0.7, (0, 0, 255), 1, cv.LINE_AA)
