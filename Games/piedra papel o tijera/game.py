...
if esImpar():
    ...
    while id < repeticiones:
        dato_jugador_1 = int(
            input("Ingrese valor para jugador Nº1 (Piedra[1]/Papel[2]/Tijera[3]): "))
        dato_jugador_2 = int(
            input("Ingrese valor para jugador Nº2 (Piedra[1]/Papel[2]/Tijera[3]): "))
        ...
        if dato_jugador_1 and dato_jugador_2 > MIN_VALOR and dato_jugador_1 and dato_jugador_2 <= MAX_VALOR:
            if dato_jugador_1 == dato_jugador_2:
                ...
                print(
                    resultado + f', Rondas ganadas acumuludas : {rondas_ganadas_jugador_2}')

            elif dato_jugador_1 == PIEDRA and dato_jugador_2 == TIJERA:
                resultado = 'Ganador de ronda: Jugador Nº1 '
                rondas_ganadas_jugador_1 += 1
                print(
                    resultado + f', Rondas ganadas acumuludas : {rondas_ganadas_jugador_1}')
    ...
    print(
        f'el numero {repeticiones} no es impar , introduzca un numero impar porfavor')
print('')
